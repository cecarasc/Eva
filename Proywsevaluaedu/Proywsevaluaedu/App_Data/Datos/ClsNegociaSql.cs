...
{
    public class ClsNegociaSql : ClsDatosSql, INegocio
    {
        #region CONSTRUCTOR
        public ClsNegociaSql(int tipoAutentica)
            : base
                (tipoAutentica)
        {

        }
        public ClsNegociaSql()
            : base(1)
        {
            _servidor = @"CARASC2\SQLEXPRESS2014";
            _bd = "EVALUACIONDC";
            _usuario = "sa ";
            _password = "Dbasa01";
        ...
        public ClsNegociaSql(string cadena)
            : base
                (cadena)
        {
